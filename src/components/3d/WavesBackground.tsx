...
const WaveShaderMaterial = {
  uniforms: {
    uTime: { value: 0 },
    uColorA: { value: new THREE.Color('#004499') },
    uColorB: { value: new THREE.Color('#00ffb9') },
  },
  vertexShader: `
    varying vec2 vUv;
    uniform float uTime;
    ...
    void main() {
      ...
      float elevation = noise(vec3(position.x * 0.3, position.y * 0.3, uTime * 0.1));
      vec3 newPosition = position;
      newPosition.z += elevation * 0.3;
...
const WavesBackground: React.FC = () => {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden -z-10">
      <Canvas camera={{ position: [0, 5, 5], fov: 60, near: 0.1, far: 100 }}>
